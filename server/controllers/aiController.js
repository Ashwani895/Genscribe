...
export const generateContent = async (req, res) => {
  try {
    ...
    const toneMap = {
      ...
      rude: "Respond in a blunt tone but not abusive.",
...
Even if the user writes in another language, stay in ${language}.

Use markdown formatting when useful.
Use headings, bullet points, and code blocks if needed.
`;
